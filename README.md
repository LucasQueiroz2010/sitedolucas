...
2.0_beta11: Site do Lucas V2.0 - BETA 11: TBOU 8 + ND 10
...
ND: Esse update é um teste do novo design do TBOU, então o site pode e provávelmente vai ter mudanças drásticas.
...
2.0_beta13: Site do Lucas V2.0 - BETA 13: Atualização GAMER 15 + TBOU 10

1) Foi adicionado um tutorial no PTWE, que é um WIP, mas já consegue ensinar o básico.
2) Alguns sons/sprites novos foram adicionados ao PTWE.
3) Algumas novas imagens/sons/descrições foram adicionadas no TBOU.
...
2.0_beta14.1: Site do Lucas - BETA 14.1: TBOU 12 + UQV 23
...
2.0_beta15: Site do Lucas - BETA 15: TBOU 13 + Atualização GAMER 16 + ND 11
1) Foi adicionado/terminado a inplementação da descrição dos personagens no TSOT.
2) Foi adicionado algumas imagens em relação ao PTWE.
3) Foi adicionado um novo arquivo README.
